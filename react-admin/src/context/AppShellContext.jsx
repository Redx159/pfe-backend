...
const translations = {
  en: {
    ...
    leaves: {
      ...
      used: "Used",
      remaining: "Remaining",
      projectedEoy: "Projected (Year-End)",
      annualHistory: "Annual History",
      totalWorkdays: "Total workdays used",
      workdays: "Workdays",
    },
    attendance: {
      title: "Attendance",
    ...
    notificationPrefs: {
      ...
      meetingInvitesDesc: "Get notified when you are invited to a meeting.",
      leaveStatus: "Leave Status Updates",
      leaveStatusDesc: "Get notified when your leave is approved or rejected.",
      reminders: "Reminders",
      remindersDesc: "Receive meeting and check-out reminders.",
      vacationMode: "Vacation Mode",
      vacationModeDesc: "Mute all notifications while on vacation.",
    },
  },
  fr: {
    nav: {
      ...
      notificationPrefs: "Préf. Notifications",
      language: "Langue",
      theme: "Thème",
      light: "Clair",
      dark: "Sombre",
    ...
    leaves: {
      ...
      used: "Utilisé",
      remaining: "Restant",
      projectedEoy: "Prévision (Fin d'année)",
      annualHistory: "Historique annuel",
      totalWorkdays: "Total jours ouvrés utilisés",
    ...
    notificationPrefs: {
      ...
      subtitle: "Choisissez les notifications que vous recevez.",
      meetingInvites: "Invitations aux réunions",
      meetingInvitesDesc: "Être notifié quand vous êtes invité à une réunion.",
      leaveStatus: "Mises à jour des congés",
      leaveStatusDesc: "Être notifié quand votre congé est approuvé ou refusé.",
      reminders: "Rappels",
      remindersDesc: "Recevoir des rappels de réunion et de pointage.",
      vacationMode: "Mode vacances",
      vacationModeDesc: "Mettre en sourdine toutes les notifications.",
    },
  },
};
